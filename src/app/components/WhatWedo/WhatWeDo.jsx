        ...
        {mobileView ? (
          <div className='mobile-view'>
            ...
            <div className="mobile-service">
              <img className='mobile-service-02' src="/whatwedo/Services.svg" alt="Service" />
              <img className="lady-image" src="/whatwedo/lady-with-pencil.svg" alt="Lady with pencil" />
              <h2>BRANDING</h2>
          ...
          <div className="mobile-web-design">
            <img src="/whatwedo/Website-designing.svg" alt="Web Design" />
            <h2>WEB DESIGNING</h2>
